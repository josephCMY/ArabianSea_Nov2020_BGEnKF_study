...
#SBATCH -o log.expt_EnKF_1hrly_WDBT_ABEI
#SBATCH -e err.expt_EnKF_1hrly_WDBT_ABEI
...
export CONFIG_FILE=~/nonlinear_IR-DA/indian_ocean_osse/PSU_EnKF/scripts/config/EnKF_1hrly_WDBT_ABEI
. $CONFIG_FILE
cd $SCRIPT_DIR
. util.sh
