...
if [ $use_for == 'df' ]; then
  WRFOUT_INTERVAL=(60 60 60)
  MP_PHYSICS=(8 8 8)
fi

if [ $use_for == 'ensfcst' ]; then
  WRFOUT_INTERVAL=(30 30 30)
  MP_PHYSICS=(8 8 8)
fi

#if [ $use_for == "wrf12" ]; then
#  end_date=`advance_time $start_date 360`
#  run_minutes2=360
#  WRFOUT_INTERVAL=(30 30 30)
#else
#  run_minutes2=$run_minutes
#fi
run_minutes2=$run_minutes
