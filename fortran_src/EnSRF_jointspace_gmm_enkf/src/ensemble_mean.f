!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  integer            :: unit
  integer            :: ie, ic, it, ix, jx, kx, kxs, len, i, j, k, n, ntot, ni,nj,nk
...
call read_ensemble(i_unit,ix,jx,kx,kxs,ni,nj,nk,nv,nm,gid,sid,iid,jid,x)
...
if(gid==0) &
  call output(i_unit+numbers_en+1,ix,jx,kx,kxs,ni,nj,nk,nv,nm,s_comm,sid,iid,jid,xm,times)
