...
!
   ...
   integer               :: length                         
   integer               :: rcode                          
   integer               :: cdfid_mean, cdfid_pert         
   integer               :: nijkv, nijkv_mean, nijkv_pert  
   integer               :: index                          
   integer               :: member, v, o, i, j, k, ijkv    
   integer               :: ivtype                         
   integer               :: natts                          
   integer               :: istart_mean(1:max_num_vars)    
   integer               :: istart_pert(1:max_num_vars)    
   integer               :: id_var_mean(1:max_num_vars)    
   integer               :: id_var_pert(1:max_num_vars)    
   integer               :: ndims_mean(1:max_num_vars)     
   integer               :: ndims_pert(1:max_num_vars)     
   integer               :: one(1:max_num_dims)            
   integer               :: dimids_mean(1:max_num_dims)    
   integer               :: dimids_pert(1:max_num_dims)    
   integer               :: dims_mean(1:max_num_vars,1:max_num_dims)      
   integer               :: dims_pert(1:max_num_vars,1:max_num_dims)      

   real (kind=4), allocatable     :: data_r_3d(:,:,:)               
   real (kind=4), allocatable     :: data_r_4d(:,:,:,:)             
   real, allocatable              :: xf_mean(:)                     
   real, allocatable              :: xf_pert(:)                     

   character (len=3)     :: ce                        
   character (len=10)    :: cv(1:max_num_vars)        
   character (len=160)   :: path                      
   character (len=160)   :: file_mean                 
   character (len=160)   :: file_pert                 
   character (len=160)   :: input_file_mean           
   character (len=160)   :: input_file_pert           
