...
program da_tune_obs_desroziers
   ...
   type pixel_type
      type (field_type), pointer :: pixel(:)   
   end type pixel_type

   type radiance_type
      character*20               :: rttovid_string
      integer                    :: nchan
      integer, pointer           :: num_rad_tot(:)        
      real   , pointer           :: trace_rad  (:), &     
                                    jo_rad     (:), &     
                                    joa_rad    (:), &     
                                    factor_rad (:)        
      type (pixel_type), pointer :: tb(:)                 
...
subroutine read_namelist_radiance
   ...
   character(len=filename_len) :: namelist_file      
