...
12    end do
      ...
      h=xa(khi)-xa(klo)
      if (h.eq.0.)  CALL wrf_error_fatal3("<stdin>",14656,&
...
11    end do
      ...
      do m=1,n-1
        do i=1,n-m
          ...
          w=c(i+1)-d(i)
          den=ho-hp
          if(den.eq.0.)  CALL wrf_error_fatal3("<stdin>",14692,&
...
13    end do
     ...
     &             (10 ** (-3.49149 * (tsot - 1)) - 1)
      ...
      if (n_atau<0 .or.n_atau>mxat) CALL wrf_error_fatal3("<stdin>",14877,&
'errro in Aerosol Tau / Wavelengths. STOP program')  
      if (ifg < 0 .or. ifg > 8) CALL wrf_error_fatal3("<stdin>",14879,&
'Error in ifg: Aerosol RH% Flag. STOP program')  
      ...
      if (itps(iac).eq.1) then
        ...
        itp = iac
        if ( itp < 1 .or. itp > naer ) CALL wrf_error_fatal3("<stdin>",14889,&
...
'ivd : Aerosol Profile flag. STOP program')  
        ...
        case (1:2)   
          ...
          if(sump.eq.0.) CALL wrf_error_fatal3("<stdin>",15038,&
