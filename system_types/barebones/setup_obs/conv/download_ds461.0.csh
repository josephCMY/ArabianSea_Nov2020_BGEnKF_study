...
wget $cert_opt -O auth_status.rda.ucar.edu --save-cookies auth.rda.ucar.edu.$$ --post-data="email=chanmanyau@gmail.com&passwd=$passwd&action=login" https://rda.ucar.edu/cgi-bin/login
#
# download the file(s)
...
wget $cert_opt $opts --directory-prefix=$outdir --load-cookies auth.rda.ucar.edu.$$ https://rda.ucar.edu/data/ds461.0/little_r/$ccyy/SURFACE_OBS:$ccyy$mmddhh
#
# clean up
