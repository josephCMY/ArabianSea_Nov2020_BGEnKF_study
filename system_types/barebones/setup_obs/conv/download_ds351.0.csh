...
wget $cert_opt -O auth_status.rda.ucar.edu --save-cookies auth.rda.ucar.edu.$$ --post-data="email=EMAIL_ADDRESS&passwd=$passwd&action=login" https://rda.ucar.edu/cgi-bin/login
#
# download the file(s)
...
wget $cert_opt $opts --directory-prefix=$outdir --load-cookies auth.rda.ucar.edu.$$ https://rda.ucar.edu/data/ds351.0/little_r/$ccyy/OBS:$ccyy$mmddhh
#
# clean up
