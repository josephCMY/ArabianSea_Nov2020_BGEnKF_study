...
parent_id  = 0,1,2,3
parent_grid_ratio = 1,`for i in $(seq 2 $MAX_DOM_FCST); do printf ${GRID_RATIO[$i-1]}, ; done`
parent_time_step_ratio = 1,`for i in $(seq 2 $MAX_DOM_FCST); do printf ${TIME_STEP_RATIO[$i-1]}, ; done`
